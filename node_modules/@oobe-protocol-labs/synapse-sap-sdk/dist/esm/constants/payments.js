 ...
 * @since v0.11.0
 */
export function computeRequiredStakeLamports(escrowLamports) {
    if (escrowLamports < 0n) {
        throw new RangeError("escrowLamports must be ≥ 0");
    }
    const coverage = (escrowLamports * STAKE_COVERAGE_BPS) / 10000n;
 ...
 * @since v0.10.0
 */
export function isAcceptedUsdcMint(mint) {
 ...
 * @since v0.10.0
 */
export function isAcceptedPaymentToken(tokenMint) {
