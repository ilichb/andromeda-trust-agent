 ...
 * @since v0.5.0
 */
export function parseSapInstructionsFromList(instructions, coder, sapProgramId) {
    const results = [];
 ...
 * @since v0.5.0
 */
export function parseSapInstructionNamesFromList(instructions, coder, sapProgramId) {
 ...
 * @since v0.5.0
 */
export function containsSapInstruction(instructions, sapProgramId) {
