 ...
 * @since v0.5.0
 */
export function parseSapInstructionsFromTransaction(tx, coder, sapProgramId, addressLookupTables) {
 ...
 * @since v0.5.0
 */
export function parseSapInstructionNamesFromTransaction(tx, coder, sapProgramId, addressLookupTables) {
...
function decompileTransaction(tx, addressLookupTables) {
    ...
    if (isVersioned) {
        ...
        const decompiledMessage = TransactionMessage.decompile(message, addressLookupTables?.length
