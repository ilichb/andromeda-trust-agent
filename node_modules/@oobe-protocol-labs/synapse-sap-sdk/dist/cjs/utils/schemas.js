...
exports.createEndpointDescriptorSchema = createEndpointDescriptorSchema;
exports.createHealthCheckSchema = createHealthCheckSchema;
exports.createToolManifestEntrySchema = createToolManifestEntrySchema;
exports.createAgentManifestSchema = createAgentManifestSchema;
exports.createPreparePaymentSchema = createPreparePaymentSchema;
exports.createRegisterAgentSchema = createRegisterAgentSchema;
exports.createCallArgsSchema = createCallArgsSchema;
 ...
 * @since v0.6.0
 */
function createEndpointDescriptorSchema() {
    const z = getZod();
    return z.object({
        url: z.string().url(),
 ...
 * @since v0.6.0
 */
function createToolManifestEntrySchema() {
    const z = getZod();
    return z.object({
 ...
 * ```
 */
function createAgentManifestSchema() {
    const z = getZod();
    return z.object({
 ...
 * @since v0.6.0
 */
function createPreparePaymentSchema() {
    const z = getZod();
    return z.object({
 ...
 * @since v0.6.0
 */
function createRegisterAgentSchema() {
    const z = getZod();
    return z.object({
        name: z.string().min(1).max(64),
